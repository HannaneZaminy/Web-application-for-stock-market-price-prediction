...
# C:\Users\MRSZAMINI\Desktop\ML
def get_data():
    if symbol=='Saipa':
        df=pd.read_csv('C:/Users/MRSZAMINI/Desktop/ML/Saipa.csv')
    elif symbol=='Khodro':
        df=pd.read_csv('C:/Users/MRSZAMINI/Desktop/ML/Khodro.csv')
    elif symbol=='Zamyad':
        df=pd.read_csv('C:/Users/MRSZAMINI/Desktop/ML/Zamyad.csv')
...
tab1,tab2 = st.tabs(["SVR Regression" ,"Linear Regression , Decision Tree Regression ,ARIMA , Neural Network"])
# In[11]:
